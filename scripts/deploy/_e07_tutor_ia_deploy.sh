...
docker compose -f docker/compose/staging.yml --env-file .env.staging up -d --build --force-recreate admin web
...
docker compose -f docker/compose/staging.yml --env-file .env.staging --profile bootstrap run --rm admin-bootstrap tutor-ia
