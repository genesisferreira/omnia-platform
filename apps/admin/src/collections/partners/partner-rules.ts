/**
 * Regras puras do Partner Network — testáveis sem DB.
 */
...
/** Statuses de moderação / publicação (obrigatórios no workflow admin). */
...
/**
 * `draft` permanece na modelagem alinhado à arquitetura (rascunho interno).
 * Não é removido: permite preparação antes de submeter à fila `pending`.
 */
...
export const isValidPartnerSlug = (value: string): boolean =>
