...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_companies_status" AS ENUM('active', 'inactive');
  ...
  CREATE TABLE "companies" (
  	...
  	"logo_id" integer,
  	"external_site" varchar,
  	"ecosystem_role" varchar NOT NULL,
  ...
  CREATE TABLE "global_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'Omnia Platform' NOT NULL,
  	"tagline" varchar DEFAULT 'Ecossistema digital da Omnia Frigo Holding',
  	"contact_email" varchar,
  	"hero_title" varchar DEFAULT 'Ecossistema Omnia Frigo Holding',
  	"hero_subtitle" varchar,
  	"cta_label" varchar DEFAULT 'Conheça o ecossistema',
  	"cta_url" varchar DEFAULT '#ecossistema',
