...
| **PartnerFavorite** / **PartnerFollow** _(opcional Fase 2)_ | Engajamento do visitante autenticado.                                                                                          |
...
| **Organization ↔ Partner** _(opcional)_ | Alinhamento com Organizations já existentes no ecossistema Omnia, sem acoplar demais no MVP.       |
...
| **GeoQueryLog** _(opcional)_ | Telemetria agregada de buscas (produto/analytics), sem PII desnecessária.             |
...
| **Professor / Instrutor** _(futuro)_ | Emite ou valida certificações ligadas a cursos.                                              |
...
- Não suspenso.
- _(Futuro)_ programa/assinatura em dia.
