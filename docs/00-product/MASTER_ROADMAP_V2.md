...
| **Riscos**       | Conteúdo hardcoded (_Ecosystem, Header, Footer_)                               |
| **Dependências** | Sprint 1.2                                                                     |

_\* dívida documentada — Sprint 3_
...
_Este roadmap substitui a numeração conflitante em `docs/13-roadmap/README.md` para Sprints 3+._
